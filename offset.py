...
st.set_page_config(page_title="Offset 90° Exacto", layout="centered")
st.title("Cálculo de Offset a 90° Exactos (Estilo AutoCAD)")
...
def generar_grafico(x1, y1, x2, y2, P1o, P2o, lado, L):
    ...
    ax.set_title("Offset a 90° Exactos", pad=10)
    return fig
...
st.success("Offset perpendicular exacto calculado correctamente (90°00′00″).")

# Mostrar gráfico
with st.spinner("Generando gráfico..."):
    fig = generar_grafico(x1, y1, x2, y2, P1_offset, P2_offset, lado, L)
    st.pyplot(fig, use_container_width=True)

st.caption("Offset calculado con ángulo perpendicular exacto (90°00′00″).")
